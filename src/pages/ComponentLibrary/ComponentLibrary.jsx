            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Typography variant="body" weight="medium">
                  Button States (hover to see interactions)
                </Typography>
            ...
            <div className="space-y-3">
              <div className="flex items-baseline gap-4">
                ...
                <Typography variant="h1">
                  32 px font-size / 38 line height
                </Typography>
              </div>
              <div className="flex items-baseline gap-4">
                <span
                ...
                <Typography variant="h2">
                  28 px font-size / 36 line height
                </Typography>
              </div>
              <div className="flex items-baseline gap-4">
                <span
                ...
                <Typography variant="h3">
                  26 px font-size / 32 line height
                </Typography>
              </div>
              <div className="flex items-baseline gap-4">
                <span
                ...
                <Typography variant="h4">
                  24 px font-size / 30 line height
                </Typography>
              </div>
              <div className="flex items-baseline gap-4">
                <span className="w-8 text-sm" style={{ color: "#a8b95e" }}>
                  H5
                </span>
                <Typography variant="h5" style={{ color: "#2a2c31" }}>
                  22 px font-size / 28 line height
                </Typography>
              </div>
              <div className="flex items-baseline gap-4">
                <span className="w-8 text-sm" style={{ color: "#676a73" }}>
                  H6
                </span>
                <Typography variant="h6" style={{ color: "#676a73" }}>
                  20 px font-size / 26 line height
                </Typography>
              </div>
            </div>
          </section>
