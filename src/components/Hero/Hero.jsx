        ...
        <div className="container">
          <div className="hero__about">
            ...
            <p className="hero__about-description">
              ...
              teknoloji, inovasyon, dijital dönüşüm ve geleceğin üretim
              modelleri ekseninde sosyal bilimler ile mühendislik ve fen
              bilimlerini bir araya getiren, uluslararası hakemli ve açık
          ...
          <div className="hero__magazine-image">
            <img
              src={magazineImage}
              alt="Profuture Teknoloji Dergisi Son Sayı"
            />
          </div>
        </div>
      </div>
